 ...
 *
 * Matrix match: (TauriSpiraler, AndroidSpiraler) → Tauri Android bridge
 *
...
export const tauriAndroidCommandsTreadle = defineTreadle({
  ...
  hookups: [
    // Kotlin hookup: Add FoundframeCommandProvider to ApiPlugin
    {
      ...
      classes: {
        ApiPlugin: {
          ...
          methods: {
            load: {
              // Prepend/append - array of lines form
              append: [
    ...
    // RustModule hookup: Ensure spire module is declared (fallback)
    {
      path: 'src/lib.rs',
      moduleDeclarations: [
        // Lines form: raw module declaration
        '#[path = "../spire/src/lib.rs"] pub mod spire;'
      ]
    }
  ]
});
