 ...
 * - person, post, media, bookmark, conversation: streamable entities
...
// TODO: remove these after full migration to TheStream™ architecture
// ============================================
...
/** @deprecated Use `inputDraft` instead */
export const inputDrafts = inputDraft;
/** @deprecated Use `schemaMeta` instead */
export const schemaMetaLegacy = schemaMeta;
