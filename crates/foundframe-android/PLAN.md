# o19-android Implementation Plan
...
```bash
# From monorepo root
cd code/packages/android

# Build release AAR
./gradlew assembleRelease

# Output location
ls build/outputs/aar/o19-android-release.aar

# Copy to DearDiary
cp build/outputs/aar/o19-android-release.aar \
...
### 1. Copy AAR
- [ ] Copy `o19-android-release.aar` to DearDiary's `app/libs/`

### 2. Update build.gradle
- [ ] Add `implementation files('libs/o19-android-release.aar')`
