...
//
// Template: /home/mnzaki/Projects/circulari.ty/o19/packages/spire-loom/machinery/bobbin/tauri/README.md.mejs
// Template file: README.md.mejs
// To override: Copy this template to loom/bobbin/tauri/README.md.mejs
//
...
Both platforms are registered under the **same plugin name** (`foundframe-tauri`):

```rust
// In your main src/lib.rs
pub fn init<R: Runtime>() -> TauriPlugin<R> {
  Builder::new("foundframe-tauri")
...
fn handle_request<R: Runtime>(app: AppHandle<R>) {
  ...
  app.spireFoundframePlatform().method_name();
}
```
