...
//!
//! This trait abstracts all RustExternalLayer operations across platforms.
//! Implementations:
//! - Desktop: Direct RustExternalLayer calls
//! - Android: JNI calls to RustExternalLayer-android service
...
/// Platform trait abstracts all RustExternalLayer operations.
///
...
/// - Desktop: Direct RustExternalLayer integration
/// - Android: JNI calls to foreground service
/// - iOS: Not implemented (stub)
pub trait SpireRustExternalLayerPlatformTrait: Send + Sync {
