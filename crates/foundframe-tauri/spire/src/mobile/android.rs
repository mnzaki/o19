...
//!
//! Uses JNI calls to communicate with the RustExternalLayer-android service.
...
///
/// Connects to the RustExternalLayer-android service via JNI.
...
impl<R: Runtime> SpireRustExternalLayerPlatformTrait for AndroidPlatform<R> {
  ...
  fn bookmark_add_bookmark(
    ...
    // TODO: Call into RustExternalLayer-android service via JNI
