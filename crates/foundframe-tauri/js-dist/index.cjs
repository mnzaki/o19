...
var foundframeFront = require('@o19/foundframe-front');
var sqliteProxy = require('drizzle-orm/sqlite-proxy');
var schema = require('@o19/foundframe-drizzle/schema');
var adaptors = require('@o19/foundframe-drizzle/adaptors');
var ports = require('@o19/foundframe-front/ports');
...
function createDrizzleProxy(dbName) {
    try {
        const db = sqliteProxy.drizzle(async (sql, params, method) => {
            try {
                const rows = await core.invoke('plugin:o19-foundframe-tauri|run_sql', {
                    query: { sql, params }
                });
 ...
 */
class TauriDeviceAdaptor extends ports.DeviceAdaptor {
    async generatePairingQr(deviceName) {
        const result = await core.invoke('plugin:o19-foundframe-tauri|generate_pairing_qr', {
            deviceName
        });
    ...
    async parsePairingUrl(url) {
        const result = await core.invoke('plugin:o19-foundframe-tauri|parse_pairing_url', {
            url
        });
        return {
    ...
    async confirmPairing(nodeIdHex, alias) {
        const result = await core.invoke('plugin:o19-foundframe-tauri|confirm_pairing', {
            nodeIdHex,
            alias
        });
        return {
    ...
    async listPairedDevices() {
        const results = await core.invoke('plugin:o19-foundframe-tauri|list_paired_devices');
    ...
    async checkFollowersAndPair() {
        const results = await core.invoke('plugin:o19-foundframe-tauri|check_followers_and_pair');
        return results.map(r => ({
            nodeId: r.nodeId,
            alias: r.alias,
            paired: r.paired
    ...
    async unpairDevice(nodeIdHex) {
        await core.invoke('plugin:o19-foundframe-tauri|unpair_device', {
            nodeIdHex
        });
    }
}
...
// Bookmark Adaptor
// ============================================================================
class TauriBookmarkAdaptor extends adaptors.DrizzleBookmarkAdaptor {
    async create(data) {
        // Call Tauri command which delegates to platform
        const result = await core.invoke('plugin:o19-foundframe-tauri|add_bookmark', {
            url: data.url,
            title: data.title,
            notes: data.notes
        });
...
// Post Adaptor
// ============================================================================
class TauriPostAdaptor extends adaptors.DrizzlePostAdaptor {
    async create(data) {
        ...
        const content = data.bits
            ...
            .join('');
        // Call Tauri command
        const result = await core.invoke('plugin:o19-foundframe-tauri|add_post', {
            content,
...
class TauriMediaAdaptor extends adaptors.DrizzleMediaAdaptor {
    async create(data) {
        ...
        if (data.uri.startsWith('http://') || data.uri.startsWith('https://')) {
            ...
            const result = await core.invoke('plugin:o19-foundframe-tauri|add_media_link', {
...
// Person Adaptor
// ============================================================================
class TauriPersonAdaptor extends adaptors.DrizzlePersonAdaptor {
    async create(data) {
        const result = await core.invoke('plugin:o19-foundframe-tauri|add_person', {
...
// ============================================================================
class TauriConversationAdaptor extends adaptors.DrizzleConversationAdaptor {
    async create(data) {
        ...
        const result = await core.invoke('plugin:o19-foundframe-tauri|add_conversation', {
            conversationId,
            title: data.title
        });
        return {
...
class TauriStreamAdaptor extends adaptors.DrizzleStreamAdaptor {
    /**
     * Add a text note to a directory
     */
    async addTextNote(params) {
        const result = await core.invoke('plugin:o19-foundframe-tauri|add_text_note', {
            directory: params.directory,
            subpath: params.subpath,
...
function createTauriAdaptors(db) {
    ...
    const view = new adaptors.DrizzleViewAdaptor(db, stream);
    return {
 ...
 */
class TauriPreviewAdaptor extends foundframeFront.PreviewAdaptor {
    async getForURL(url) {
        const result = await core.invoke('plugin:o19-foundframe-tauri|url_preview_json', { url });
...
function createServices(dbName = "database.db") {
    ...
    return foundframeFront.createServices({
        ...adaptors,
        preview: new TauriPreviewAdaptor(),
    });
}
async function convertJpegToWebp(jpeg) {
    const bytes = await core.invoke('plugin:o19-foundframe-tauri|convert_jpeg_to_webp', {
        payload: { jpeg }
    });
    return Uint8Array.from(bytes);
}
async function compressWebpToSize(webp, maxSize) {
    const bytes = await core.invoke('plugin:o19-foundframe-tauri|compress_webp_to_size', {
        payload: { webp, maxSize }
    });
    return Uint8Array.from(bytes);
}
async function requestPermissions() {
    return await core.invoke('plugin:o19-foundframe-tauri|request_permissions');
}
async function generatePairingQr(deviceName) {
    return await core.invoke('plugin:o19-foundframe-tauri|generate_pairing_qr', { deviceName });
}
async function parsePairingUrl(url) {
    return await core.invoke('plugin:o19-foundframe-tauri|parse_pairing_url', { url });
}
async function confirmPairing(nodeIdHex, alias) {
    return await core.invoke('plugin:o19-foundframe-tauri|confirm_pairing', { nodeIdHex, alias });
}
async function listPairedDevices() {
    return await core.invoke('plugin:o19-foundframe-tauri|list_paired_devices');
}
async function checkFollowersAndPair() {
    return await core.invoke('plugin:o19-foundframe-tauri|check_followers_and_pair');
}
async function unpairDevice(nodeIdHex) {
    return await core.invoke('plugin:o19-foundframe-tauri|unpair_device', { nodeIdHex });
}
/**
...
async function startCamera(options = {}) {
    return await core.invoke('plugin:o19-foundframe-tauri|start_camera', {
        options: {
...
async function stopCamera() {
    return await core.invoke('plugin:o19-foundframe-tauri|stop_camera');
}
/**
...
async function capturePhoto() {
    return await core.invoke('plugin:o19-foundframe-tauri|capture_photo');
}
/**
 * Change camera mode without stopping/starting.
 */
async function setCameraMode(options) {
    return await core.invoke('plugin:o19-foundframe-tauri|set_camera_mode', {
        options: {
            mode: options.mode || 'preview',
            cameraDirection: options.cameraDirection || 'back'
        }
...
async function isCameraActive() {
    return await core.invoke('plugin:o19-foundframe-tauri|is_camera_active');
}
/**
 * Request camera permissions.
 */
async function requestCameraPermissions() {
    return await core.invoke('plugin:o19-foundframe-tauri|request_camera_permissions');
}
/**
 * Check camera permission status.
 */
async function checkCameraPermissions() {
    return await core.invoke('plugin:o19-foundframe-tauri|check_camera_permissions');
}
/**
...
exports.PHOTO_CAPTURED_EVENT = PHOTO_CAPTURED_EVENT;
exports.QR_SCANNED_EVENT = QR_SCANNED_EVENT;
exports.TauriBookmarkAdaptor = TauriBookmarkAdaptor;
exports.TauriConversationAdaptor = TauriConversationAdaptor;
exports.TauriDeviceAdaptor = TauriDeviceAdaptor;
exports.TauriMediaAdaptor = TauriMediaAdaptor;
exports.TauriPersonAdaptor = TauriPersonAdaptor;
exports.TauriPostAdaptor = TauriPostAdaptor;
exports.TauriStreamAdaptor = TauriStreamAdaptor;
exports.capturePhoto = capturePhoto;
exports.checkCameraPermissions = checkCameraPermissions;
exports.checkFollowersAndPair = checkFollowersAndPair;
exports.compressWebpToSize = compressWebpToSize;
exports.confirmPairing = confirmPairing;
exports.convertJpegToWebp = convertJpegToWebp;
exports.createServices = createServices;
exports.createTauriAdaptors = createTauriAdaptors;
exports.generatePairingQr = generatePairingQr;
exports.isCameraActive = isCameraActive;
exports.listPairedDevices = listPairedDevices;
exports.parsePairingUrl = parsePairingUrl;
