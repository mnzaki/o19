//! Example: Using the FoundframeRadicleClient from tauri-plugin-o19-ff
//!
//! This shows how the tauri-plugin should consume the android-activities
//! crate to connect to the singleton service.

use android_activities::{BpFoundframeRadicle, FoundframeRadicleClient};
use rsbinder::*;
