...
In `tauri-plugin-o19-ff/Cargo.toml`:

```toml
[dependencies]
android-activities = { path = "../../packages/android-activities" }
```

## 2. Update Android Plugin Code

In `tauri-plugin-o19-ff/android/src/main/java/.../MobilePlugin.kt` or similar:
...
In `tauri-plugin-o19-ff/src/mobile.rs`:

```rust
use android_activities::BpFoundframeRadicle;
use rsbinder::*;
...
From the `android-activities` directory:
